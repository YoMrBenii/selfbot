...
async def on_message(message):
    ...
    now = time.time()
    if isinstance(message.channel, discord.DMChannel) and message.author.id == 1118218807694065684:
        generalchannel = client.get_channel(1108669775099461633)
